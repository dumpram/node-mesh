...
void node_configuration(void);
void node_wait_for_start(void);
void node_wait_data(void);
void node_add_data(void);
void node_propagate_data(void);
void node_propagate_config_data(void);
void node_sleep_until_next_interval(void);
void node_create_new_config_data(void);
void node_ammend_this(void);
void node_ammend_parent(void);
void node_get_config_ack(void);
